...
const OuvertureEnqueteLRPComponent = (props: any) => {
  ...
  useEffect(() => {
    ...
    ModalValues.setLink(
      "https://lspd-online.forumactif.com/f69-traitement-des-plaintes"
    );
  });
  ...
  return (
    <PageLayout>
      ...
      <GenerateButtonComponent rapportType="OUVERTENQLRP" {...propsToSend} />
    </PageLayout>
  );
};

export { OuvertureEnqueteLRPComponent };
